...
from . import views
from .views import SomeAdminView
...
urlpatterns = [
    ...
    path('clients/<int:pk>/delete/', views.ClientDeleteView.as_view(), name='client_confirm_delete'),
    ...
    path('admin-panel/', SomeAdminView.as_view(template_name='mailings/admin_panel.html'), name='admin_panel'),
]
